...
namespace Stash.Specifications.for_engine.for_partitioning.given_partitioned_storage_work
{
    ...
    public class when_told_to_insert_a_graph_that_the_partition_is_not_responsible_for : AutoMockedSpecification<PartitionedStorageWork>
    {
        ...
        [Then]
        public void it_should_not_insert_the_graph()
        {
            Dependency<IStorageWork>().AssertWasNotCalled(_ => _.InsertGraph(Arg<ITrackedGraph>.Is.Anything));
        }
    }
}