...
namespace Stash.Specifications.for_engine.for_partitioning.given_partitioned_storage_work
{
    ...
    public class when_told_to_update_a_graph_that_the_partition_is_not_responsible_for : AutoMockedSpecification<PartitionedStorageWork>
    {
        ...
        {
            Subject.UpdateGraph(mockTrackedGraph);
        }
        ...
        [Then]
        public void it_should_not_update_the_graph()
        {
            Dependency<IStorageWork>().AssertWasNotCalled(_ => _.UpdateGraph(Arg<ITrackedGraph>.Is.Anything));
        }
    }
}