namespace Stash.Specifications.for_configuration.given_registered_indexer
{
    ...
    {
        [Test]
        public void it_should_ask_tell_the_backing_store_ensure_the_indexer_is_managed()
        {
            ...
            mockBackingStore.AssertWasCalled(backingStore => backingStore.EnsureIndexer<DummyPersistentObject, object>(fakeIndexer));
        }
    }
}