...
namespace Stash.Azure.Specifications.given_queries
{
    ...
    public class when_executing_any_of_having_query_key_that_doesnt_exist : with_int_indexer
    {
        ...
        protected override void Given()
        {
            ...
            query = new AnyOfQuery<int>(Subject.IndexDatabases[RegisteredIndexer.IndexName], RegisteredIndexer, new[] {101, 98, 99});
        }
