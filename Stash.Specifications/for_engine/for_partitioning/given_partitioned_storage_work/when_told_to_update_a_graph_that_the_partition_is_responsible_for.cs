...
namespace Stash.Specifications.for_engine.for_partitioning.given_partitioned_storage_work
{
    ...
    public class when_told_to_update_a_graph_that_the_partition_is_responsible_for : AutoMockedSpecification<PartitionedStorageWork>
    {
        ...
        [Then]
        public void it_should_update_the_graph()
        {
            Dependency<IStorageWork>().AssertWasCalled(_ => _.UpdateGraph(Arg.Is(mockTrackedGraph)));
        }
    }
}